...
//Value of optional type 'int?' must unwrapped to a value of type 'int'
print(userAge!)
...
//Because userInputAge is "34e" which is not a valid integer, the failable Initializer returns nil
