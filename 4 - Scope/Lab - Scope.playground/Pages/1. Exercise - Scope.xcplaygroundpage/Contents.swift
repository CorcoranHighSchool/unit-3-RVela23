...
//print("The value of foo is \(foo)")
//Because foo is declared in the for loop and is trying to be accessed outside its scope
...
//x is declared as global scope on line 17 and therefore can be accessed and modified at any further restricting scope
